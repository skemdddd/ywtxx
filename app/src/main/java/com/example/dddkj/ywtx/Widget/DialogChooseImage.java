...
import com.example.dddkj.ywtx.utils.RxPermissionsUtils;
...
public class DialogChooseImage extends MyDiallog {
    ...
    private void initView(final Activity context) {
        ...
        tv_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
//                请求Camera权限
                RxPermissionsUtils.requestRrad(context, new onRequestListener() {
                    @Override
                    public void onRequestBefore() {
                        T.showShort(context,"请开启读取权限");
                    }
