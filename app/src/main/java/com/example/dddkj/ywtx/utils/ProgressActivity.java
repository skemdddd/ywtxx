...
public class ProgressActivity extends RelativeLayout {
        ...
        private void init(AttributeSet attrs) {
            ...
            loadingStateProgressBarWidth =
                    typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_loadingProgressBarWidth, 60);

            loadingStateProgressBarHeight =
                    typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_loadingProgressBarHeight, 60);
    ...
    public void showEmpty(Drawable emptyImageDrawable, String emptyTextTitle, String emptyTextContent,OnClickListener onClickListener) {
        ...
        private void setLoadingView() {
            if (loadingStateRelativeLayout == null) {
                ...
                loadingStateProgressBar = (ProgressBar) view.findViewById(R.id.progressbar);
